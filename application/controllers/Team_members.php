...
class Team_members extends MY_Controller {
    ...
    function modal_form() {
        ...
        $view_data["custom_fields"] = $this->Custom_fields_model->get_combined_details("team_members",  $view_data['model_info']->id)->result();
    ...
    function add_team_member() {
        ...
        if ($user_id) {
            ...
            save_custom_fields("team_members", $user_id);
    ...
    function general_info($user_id) {
        ...
        $view_data["custom_fields"] = $this->Custom_fields_model->get_combined_details("team_members",  $user_id)->result();

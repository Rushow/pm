...
class Settings extends MY_Controller {
    ...
    function save_client_settings() {
        $settings = array("disable_client_login", "disable_client_signup", "client_message_users", "client_can_create_tasks", "client_can_edit_tasks", "client_can_view_tasks", "client_can_comment_on_tasks", "client_can_view_project_files", "client_can_add_project_files", "client_can_comment_on_files");
    ...
    function notification() {
        $this->template->rander("settings/notification/index");
    }
    ...
    function notification_settings_list_data() {
        ...
        $list_data = $this->Notification_settings_model->get_details()->result();
        $result = array();

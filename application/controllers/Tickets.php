...
class Tickets extends MY_Controller {
    ...
    function modal_form() {
        ...
        $view_data["custom_fields"] = $this->Custom_fields_model->get_combined_details("tickets",  $view_data['model_info']->id)->result();
    ...
    function save() {
        ...
        if ($ticket_id) {
             ...
             save_custom_fields("tickets", $ticket_id);
    ...
    function view($ticket_id = 0) {
        ...
        if ($ticket_id) {
            ...
            if ($ticket_info) {
                ...
                $view_data['custom_fields_list'] = $this->Custom_field_values_model->get_details( array("related_to_type" => "tickets", "related_to_id" => $ticket_info->id))->result();

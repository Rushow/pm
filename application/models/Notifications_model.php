...
class Notifications_model extends Crud_model {
    ...
    function create_notification($event, $user_id, $options = array()) {
        ...
        $sql = "SELECT $users_table.id, $users_table.email, $users_table.enable_web_notification, $users_table.enable_email_notification
                FROM $users_table
        ...
        if ($notification_id && $email_notify_to) {
            send_notification_emails($notification_id, $email_notify_to);
        }
    }
